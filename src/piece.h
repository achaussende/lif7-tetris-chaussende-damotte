/**
    ...
    procédures, accesseurs et mutateurs, et la structure d'une pièce
...
/**
    @enum Color
*/
typedef enum {YELLOW = 1, CYAN = 2, GREEN = 3, RED = 4,
ORANGE = 5, BLUE = 6, PURPLE = 7} Color;
...
typedef struct
{
    ...
    /**
        ...
        @param pointeur sur une Piece, un entier kind, une Color,
        et entier orientation
    */
    void initPiece(Piece * piece, const unsigned int kind,
                   const Color color, const unsigned int orientation);
    ...
    */
    Piece * createPiece(const unsigned int kind,
                        const unsigned int orientation);

    /**

        @brief Procédure de libération d'une piece
        @param pointeur sur une Piece
    */
    ...
    /**
        ...
        @param pointeur sur une Piece et un entier kind
    */
    ...
    */
    ...
    /**
        ...
        @param pointeur sur une Piece et un entier orientation
    */
    ...
    */
    ...
    /**
        ...
        @param pointeur sur une Piece et une Color
    */
    ...
    */
    ...
    /**
        ...
        @param pointeur sur une Piece et un entier
    */
